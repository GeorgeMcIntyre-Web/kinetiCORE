...
import { SearchGraph } from '../../src/routing/pathfinding/SearchGraph';
import { RouteOptimizer, createCancellationToken } from '../../src/routing/pathfinding/RouteOptimizer';
import { ShortestPathCost, SafestPathCost, AestheticPathCost } from '../../src/routing/pathfinding/CostFunction';
import { ConnectionPoint } from '../../src/routing/core/ConnectionPoint';
import { RouteConstraints, ConnectionSpecifications } from '../../src/routing/core/types';
...
describe('Agent 1 - Pathfinding & Optimization', () => {
  ...
  beforeEach(() => {
    // Create a minimal Babylon.js engine and scene for testing
...
function createConnectionPoint(position: Vector3): ConnectionPoint {
  const specs: ConnectionSpecifications = {
    size: '3/4"',
    material: 'steel'
  };
